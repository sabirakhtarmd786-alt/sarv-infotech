...
class TechBlogRequestHandler(http.server.BaseHTTPRequestHandler):
...
def run_server(port=8080, host="0.0.0.0"):
    ...
    with socketserver.TCPServer(server_address, TechBlogRequestHandler) as httpd:
        print(f"============================================================")
        print(f"🚀 TechBlog Server Active!")
